...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a href="../admin/tenant.html" class="fs-12 nav-link active">Tenant</a>
                ...
                <form action="" class="mb-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="button" class="btn btn-success w-237 rounded-pill btn-tambah btn-sm" data-bs-toggle="modal" data-bs-target="#addtenant">
                                <i class="bi bi-plus-circle pe-2"></i>Tambah Tenant
                            </button>
                        </div>  
                    </div>
                </form>

                <div class="modal fade" id="addtenant" tabindex="-1" aria-labelledby="addtenantLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-0">
                            <div class="modal-body p-3">
                                <p class="modal-title fs-14 sb grey" id="addtenantLabel">Tambah Tenant</p>
                                <hr style="border: 1px solid #919191;" class="mb-2 mt-1">
                
                                <div class="d-flex justify-content-center gap-3">
                                    <a type="button" class="btn btn-success rounded-pill btn-sm px-3 d-flex align-items-center" href="../admin/datatenant.html" style="min-width: 160px;">
                                        <i class="bi bi-plus-circle me-2"></i>
                                        Data Baru
                                    </a>
                                    <a type="button" class="btn btn-success rounded-pill btn-sm px-3 d-flex align-items-center" href="../admin/dataleadtenant.html" style="min-width: 190px;">
                                        <i class="bi bi-plus-circle me-2"></i>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr class="table-light text-center py-1">
                                ...
                                <td scope="col">
                                    <p class="fs-12 txt-tb-grey sb m-0">Nama Penanggungjawab</p>
                                </td>
                                <td scope="col">
                                    <p class="fs-12 txt-tb-grey sb m-0">Nama Perusahaan/Instansi</p>
                                </td>
                                <td scope="col">
                                    <p class="fs-12 txt-tb-grey sb m-0">Nomor Telepon Perusahaan</p>
                                </td>
                                <td scope="col">
                                    <p class="fs-12 txt-tb-grey sb m-0">Nomor Telepon Penanggungjawab</p>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fs-12 txt-tb-grey">PT Berkah Selalu</td>
                                <td class="fs-12 txt-tb-grey">02194809842</td>
                                <td class="fs-12 txt-tb-grey">0812768378914</td>
                                <td class="fs-12 text-center txt-tb-grey">
                                    <a href="../admin/edittenat.html">
                                        <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-4" type="button"><i class="bi bi-pencil-fill white"></i></button>
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="fs-12 txt-tb-grey">PT  Jaya Esport</td>
                                <td class="fs-12 txt-tb-grey">02194809842</td>
                                <td class="fs-12 txt-tb-grey">0812768378914</td>
                                <td class="fs-12 text-center txt-tb-grey">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group input-group-sm">
                                                <input type="password" class="form-control" id="password"
                                                    placeholder="Kata Sandi" value="12345678">
