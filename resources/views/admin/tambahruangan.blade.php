...
<body>
 ...
 <a href="#" class="fs-12 nav-link">Pengguna</a>
  ...
  <div class="main-content p-3">
    <p class="ps-14 sb grey">Tambah Ruangan Pulomas Office Park</p>
      ...
      <div class="card-body bg-white rounded-3">
        ...
        <form>
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-2">
                ...
                <input type="text" class="form-control form-control-sm rounded-1" placeholder="Kode Ruangan" />
              </div>
              <div class="mb-2">
                <label class="fs-12 txt-tb-grey">Luas Ruangan</label>
                <div class="input-group input-group-sm">
                  <input type="number" class="form-control rounded-1" placeholder="Luas Ruangan" />
                  <span class="input-group-text rounded-1">m²</span>
                </div>
              </div>
              <div class="mb-2">
                <label class="fs-12 txt-tb-grey">Deskripsi Ruangan</label>
                <textarea class="form-control form-control-sm rounded-1" rows="3" placeholder="Deskripsi Ruangan"></textarea>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="mb-2">
                ...
                <input type="text" class="form-control form-control-sm rounded-1" placeholder="Nama Ruangan" />
              </div>
              <div class="mb-2">
                <label class="fs-12 txt-tb-grey">Harga Sewa Lantai</label>
                <div class="input-group input-group-sm">
                  <span class="input-group-text rounded-1">Rp</span>
                  <input type="number" class="form-control rounded-1" value="0" disabled/>
          ...
          <div class="mb-0">
            ...
            <div class="col-9 input-group-sm d-flex flex-wrap gap-2 mt-0 mb-1">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="jangkaWaktu" id="harian">
          ...
          <div class="mb-0">
            ...
            <div class="col-9 input-group-sm d-flex flex-wrap gap-2 mt-0 mb-1">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="kondisi" id="Baik">
          ...
          <div class="d-flex justify-content-end mt-2">
           <a class="btn btn-red w-123 btn-sm rounded-pill text-white me-2" href="../admin/ruangan.html"><i class="bi bi-x-circle pe-2"></i>Batal </a>
            <button type="submit" class="btn btn-success rounded-pill btn-sm px-4">
