...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <div class="collapse show ps-3" id="masterDataMenu">
                <a href="../admin/fasilitas.html" class="fs-12 nav-link active">Fasilitas</a>
    ...
    <!-- main -->
     <div class="main-content p-3">
        <p class="ps-14 sb grey">Daftar Fasilitas Pulomas Office Park</p>
        <!-- card -->
        <div class="card border-0 w-100">
            <div class="card-body bg-white rounded-3">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="position-relative me-2 w-198">
                                ...
                                <input type="search" class="form-control rounded-pill ps-5 form-control-sm" id="email" placeholder="Cari Fasilitas">
                            </div>                                        
                        ...
                        <div class="col-md-6 text-end">
                            <button type="button" class="btn btn-success w-237 rounded-pill btn-tambah btn-sm" data-bs-toggle="modal" data-bs-target="#addfasilitas">
                                <i class="bi bi-plus-circle pe-2"></i>Tambah Fasilitas
                            </button>
                        </div>                                                                        
                    </div>
                </form>   
                ...
                <div class="modal fade" id="addfasilitas" tabindex="-1" aria-labelledby="addfasilitas" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-0">
                            <div class="modal-body p-3">
                                <p class="modal-title fs-14 sb grey" id="addfasilitas">Fasilitas Baru</p>
                                <hr style="border: 1px solid #919191;" class="mb-3">
                                <form action="">
                                    <div class="row g-2 align-items-center mb-3 ms-1 me-1">
                                        <div class="col-3">
                                            <label for="addfasilitas" class="form-label black fs-12">Nama Fasilitas</label>
                                        </div>
                                        <div class="col-9 input-group-sm">
                                            <input type="text" class="form-control w-100" id="addfasilitas" placeholder="Nama Fasilitas">
                                        </div>                                        
                                    </div>
                                    <div class="row align-items-center">
                                        <div class="col-md-12 d-flex justify-content-end">                           
                                            ...
                                            <button type="button" class="btn btn-success w-185 rounded-pill btn-sm"><i class="bi bi-plus-circle pe-2"></i>Tambah Fasilitas</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr class="table-light text-center py-1">
                            ...
                            <td scope="col"><p class="fs-12 txt-tb-grey sb m-0">Nama Fasilitas</p></td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fs-12 txt-tb-grey">Parkir Gratis</td>
                            <td class="fs-12 text-center txt-tb-grey">
                                <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-4" type="button" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil-fill white"></i></button>
                                <button type="button" class="btn btn-danger btn-sm w-36 rounded-pill ms-4" type="button" data-bs-toggle="modal" data-bs-target="#deletefasilitas"><i class="bi bi-trash3-fill white"></i></i></button>
                            </td>
                      </tr>
                        <tr>
                            <td class="fs-12 text-center" scope="row">2</td>
                            <td class="fs-12 txt-tb-grey">Toilet Umum</td>
                            <td class="fs-12 text-center txt-tb-grey">
                                <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-4" type="button" data-bs-toggle="modal" data-bs-target="#editfasilitas"><i class="bi bi-pencil-fill white"></i></button>
                                <button type="button" class="btn btn-danger btn-sm w-36 rounded-pill ms-4" type="button" data-bs-toggle="modal" data-bs-target="#deletefasilitas"><i class="bi bi-trash3-fill white"></i></i></button>
                            </td>
                ...
                <div class="modal fade" id="editfasilitas" tabindex="-1" aria-labelledby="editfasilitas" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-0">
                            <div class="modal-body p-3">
                                <p class="modal-title fs-14 sb grey" id="editfasilitas">Ubah Fasilitas</p>
                                <hr style="border: 1px solid #919191;" class="mb-3">
                                <form action="">
                                    <div class="row g-2 align-items-center mb-3 ms-1 me-1">
                                        <div class="col-3">
                                            <label for="editfasilitas" class="form-label black fs-12">Nama Fasilitas</label>
                                        </div>
                                        <div class="col-9 input-group-sm">
                                            <input type="text" class="form-control w-100" id="editfasilitas" value="Parkir Gratis">
                                        </div>                                        
                                    </div>
                                    <div class="row align-items-center">
                                        <div class="col-md-12 d-flex justify-content-end">                           
                                            <button type="button" class="btn btn-red w-123 btn-sm rounded-pill text-white me-2" data-bs-dismiss="modal"><i class="bi bi-x-circle pe-2"></i>Batal</button>
                                            <button type="button" class="btn btn-warning w-185 rounded-pill btn-sm text-white"><i class="bi bi-pencil-fill pe-2"></i>Ubah Fasilitas</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="modal fade" id="deletefasilitas" tabindex="-1" aria-labelledby="deletefasilitas" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-0">
                            <div class="modal-body p-3">
                                <p class="modal-title fs-14 sb grey" id="deletefasilitas">Hapus Fasilitas</p>
                                <hr style="border: 1px solid #919191;" class="mb-3">
                                <form action="">
                                    <div class="row g-2 align-items-center mb-3 ms-1 me-1">
                                        <div class="col-3">
                                            <label for="deletefasilitas" class="form-label black fs-12">Nama Fasilitas</label>
                                        </div>
                                        <div class="col-9 input-group-sm">
                                            <input type="text" class="form-control w-100" id="deletefasilitas" value="Parkir Gratis" disabled>
                                        </div>                                        
                                    ...
                                    <div class="row align-items-center mt-0">
                                        <div class="col-md-12 d-flex justify-content-end">                           
                                            ...
                                            <button type="button" class="btn btn-red w-185 rounded-pill btn-sm text-white"><i class="bi bi-trash3 pe-2"></i>Hapus Fasilitas</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
