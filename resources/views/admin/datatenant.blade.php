    ...
    <div class="card border-0 w-100">
      <div class="card-body bg-white rounded-3">
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control form-control-sm rounded-1" id="companyName"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control form-control-sm rounded-1" id="companyPhone"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="email" class="form-control form-control-sm rounded-1" id="companyEmail"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control form-control-sm rounded-1" id="companyAddress"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control form-control-sm rounded-1" id="picName"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="email" class="form-control form-control-sm rounded-1" id="picEmail"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control form-control-sm rounded-1" id="picAddress"
        ...
        <div class="mb-3 row align-items-center">
          ...
          <div class="col-sm-8">
            <input type="email" class="form-control form-control-sm rounded-1" id="accountEmail"
        ...
        <div class="justify-content-end text-end">
          <button type="button" class="btn btn-success w-185 rounded-pill btn-sm"><i
              class="bi bi-plus-circle pe-2"></i>Tambah Data Tenant</button>
