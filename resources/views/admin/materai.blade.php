...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <div class="collapse show ps-3" id="masterDataMenu">
        ...
        <a href="../admin/materai.html" class="fs-12 nav-link active">Materai</a>
      </div>
  ...
  <div class="main-content p-3">
    <p class="ps-14 sb grey">Daftar Materai Pulomas Office Park</p>
    ...
    <div class="card border-0 w-100">
      <div class="card-body bg-white rounded-3">
          ...
          <div class="row align-items-center">
            <div class="col-md-6 d-flex">
              <div class="position-relative me-2 w-198">
                ...
                <input type="search" class="form-control rounded-pill ps-5 form-control-sm" placeholder="Cari Materai">
              </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr class="table-light text-center py-1">
                ...
                <th><p class="fs-12 txt-tb-grey sb m-0">Nama Materai</p></th>
                <th><p class="fs-12 txt-tb-grey sb m-0">Harga Materai</p></th>
            ...
            <tbody>
              <tr>
                ...
                <td class="fs-12 txt-tb-grey">Materai 2022</td>
                <td class="fs-12 txt-tb-grey">Rp. 10.000</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editmaterai">
        ...
        <!-- Modals edit Materai-->
        <div class="modal fade" id="editmaterai" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content rounded-0">
                <div class="modal-body p-4">
                  <p class="modal-title fs-14 sb grey mb-2">Ubah Materai</p>
                  <hr class="mb-3" style="border: 1px solid #919191;">
                  <form>
                    <!-- Nama Materai -->
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-form-label black fs-12">Nama Materai</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" placeholder="Nama Materai" value="Materai 2022">
                      </div>
                    </div>
          
                    <!-- Harga Materai -->
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-form-label black fs-12">Harga Materai</label>
                      <div class="col-sm-8">
                        <div class="input-group input-group-sm">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" placeholder="Harga Materai" value="10.000">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end pt-3">
                      ...
                      <button type="button" class="btn btn-warning btn-sm rounded-pill text-white" style="width: 185px;">
                        <i class="bi bi-pencil-fill pe-2"></i>Ubah Materai
                      </button>
                    </div>
                  </form>
                </div>
