    ...
    <div class="card border-0 w-100">
      <div class="card-body bg-white rounded-3">
        ...
        <div class="tab-container">
          ...
          <a href="../admin//detailovertime.html" class="tab-link active">Overtime</a>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr class="table-light text-center py-1">
                      ...
                      <td scope="col">
                        <p class="fs-12 txt-tb-grey sb m-0">Satuan Waktu</p>
                      </td>
                      <td scope="col">
                        <p class="fs-12 txt-tb-grey sb m-0">Harga Satuan (/Jam/m²)</p>
                      </td>
                      <td scope="col">
                        <p class="fs-12 txt-tb-grey sb m-0">Harga Total (/Jam)</p>
                      </td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td class="fs-12 txt-tb-grey text-center">Dibawah 4 Jam</td>
                      <td class="fs-12 txt-tb-grey text-center">10.000</td>
                      <td class="fs-12 txt-tb-grey text-center">400.000</td>
                    </tr>
                    <tr>
                      <td class="fs-12 text-center" scope="row">2</td>
                      <td class="fs-12 txt-tb-grey text-center">Diatas 4 Jam</td>
                      <td class="fs-12 txt-tb-grey text-center">8.000</td>
