...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <div class="collapse show ps-3" id="masterDataMenu">
        ...
        <a href="../admin/billing.html" class="fs-12 nav-link active">Billing</a>
  ...
  <div class="main-content p-3">
    <p class="ps-14 sb grey">Daftar Billing Pulomas Office Park</p>
    ...
    <div class="card border-0 w-100">
      <div class="card-body bg-white rounded-3">
          ...
          <div class="row align-items-center">
            <div class="col-md-6 d-flex">
              <div class="position-relative me-2 w-198">
                ...
                <input type="search" class="form-control rounded-pill ps-5 form-control-sm" placeholder="Cari Billing">
              </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr class="table-light text-center py-1">
                ...
                <th><p class="fs-12 txt-tb-grey sb m-0">Nama Biling</p></th>
                <th><p class="fs-12 txt-tb-grey sb m-0">Masa Jatuh Tempo</p></th>
            ...
            <tbody>
              <tr>
                ...
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editbilling">
        ...
        <!-- Modals edit billing-->
        <div class="modal fade" id="editbilling" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
              <div class="modal-body p-3">
                <p class="modal-title fs-14 sb grey mb-2">Ubah Billing</p>
                <hr class="mb-3" style="border: 1px solid #919191;" >
                <form>
                  <!-- Nama Billing -->
                  <div class="mb-3 row align-items-center">
                    <label class="col-4 col-form-label black fs-12">Nama Billing</label>
                    <div class="col-8">
                      <input type="text" class="form-control form-control-sm" placeholder="Nama Billing" value="Sewa" disabled>
                    </div>
                  </div>
        
                  <!-- Masa Jatuh Tempo -->
                  <div class="mb-3 row align-items-center">
                    <label class="col-4 col-form-label black fs-12">Masa Jatuh Tempo</label>
                    <div class="col-8 d-flex gap-2">
                      <input type="text" class="form-control form-control-sm" placeholder="Masa Jatuh Tempo" value="14" style="width: 40%;">
                  ...
                  <div class="d-flex justify-content-end pt-2">
                    ...
                    <button type="button" class="btn btn-warning btn-sm rounded-pill text-white" style="width: 185px;">
                      <i class="bi bi-pencil-fill pe-2"></i>Ubah Billing
                    </button>
                  </div>
                </form>
              </div>
