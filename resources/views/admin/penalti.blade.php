...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <div class="collapse show ps-3" id="masterDataMenu">
        ...
        <a href="../admin/penalti.html" class="fs-12 nav-link active">Penalti</a>
  ...
  <div class="main-content p-3">
    <p class="ps-14 sb grey">Daftar Penalti Pulomas Office Park</p>
    ...
    <div class="card border-0 w-100">
      <div class="card-body bg-white rounded-3">
          ...
          <div class="row align-items-center">
            <div class="col-md-6 d-flex">
              <div class="position-relative me-2 w-198">
                ...
                <input type="search" class="form-control rounded-pill ps-5 form-control-sm" placeholder="Cari Penalti">
              </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr class="table-light text-center py-1">
                ...
                <th><p class="fs-12 txt-tb-grey sb m-0">Nama Penalti</p></th>
                <th><p class="fs-12 txt-tb-grey sb m-0">Masa Penalti</p></th>
            ...
            <tbody>
              <tr>
                ...
                <td class="fs-12 txt-tb-grey">SUrat Teguran 1</td>
                <td class="fs-12 txt-tb-grey">14 Hari</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editpenalti">
              ...
              <tr>
                ...
                <td class="fs-12 txt-tb-grey">SUrat Teguran 2</td>
                <td class="fs-12 txt-tb-grey">14 Hari</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editpenalti">
                    <i class="bi bi-pencil-fill white"></i>
              ...
              <tr>
                ...
                <td class="fs-12 txt-tb-grey">SUrat Teguran 3</td>
                <td class="fs-12 txt-tb-grey">14 Hari</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editpenalti">
                    <i class="bi bi-pencil-fill white"></i>
                ...
                <td class="fs-12 txt-tb-grey">Segel</td>
                <td class="fs-12 txt-tb-grey">14 Hari</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editpenalti">
                    <i class="bi bi-pencil-fill white"></i>
                ...
                <td class="fs-12 txt-tb-grey">Kosong</td>
                <td class="fs-12 txt-tb-grey">14 Hari</td>
                <td class="fs-12 text-center txt-tb-grey">
                  <button type="button" class="btn btn-warning btn-sm w-36 rounded-pill me-0" data-bs-toggle="modal" data-bs-target="#editpenalti">
                    <i class="bi bi-pencil-fill white"></i>
        ...
        <!-- Modals edit penalti-->
        <div class="modal fade" id="editpenalti" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
              <div class="modal-body p-3">
                <p class="modal-title fs-14 sb grey mb-2">Ubah Penalti</p>
                <hr class="mb-3" style="border: 1px solid #919191;">
                <form>
                  <!-- Nama penalti -->
                  <div class="mb-3 row align-items-center">
                    <label class="col-4 col-form-label black fs-12">Nama penalti</label>
                    <div class="col-8">
                      <input type="text" class="form-control form-control-sm" placeholder="Nama penalti" value="SUrat Teguran 1" disabled>
                    </div>
                  </div>
        
                  <!-- Masa Penalti -->
                  <div class="mb-3 row align-items-center">
                    <label class="col-4 col-form-label black fs-12">Masa Penalti</label>
                    <div class="col-8 d-flex gap-2">
                      <input type="text" class="form-control form-control-sm" placeholder="Masa Penalti" value="14" style="width: 40%;">
                  ...
                  <div class="d-flex justify-content-end pt-2">
                    ...
                    <button type="button" class="btn btn-warning btn-sm rounded-pill text-white" style="width: 185px;">
                      <i class="bi bi-pencil-fill pe-2"></i>Ubah Penalti
                    </button>
                  </div>
                </form>
              </div>
